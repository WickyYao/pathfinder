  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="slider" data-section="home">
		<div class="owl-carousel owl-carousel-fullwidth">
		    	...
		    	<div class="container" style="position: relative;">
		    		<div class="row">
					    ...
					    <div class="col-md-4 col-md-push-1 col-sm-4 col-sm-push-1 iphone-image">
					    	<div class="iphone to-animate-2"><img src="static/images/iphone-2.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
					    </div>
		    	...
		    	<div class="container" style="position: relative;">
		    		<div class="row">
					    ...
					    <div class="col-md-4 col-md-pull-7 col-sm-4 col-sm-pull-7 iphone-image">
					    	<div class="iphone to-animate-2"><img src="static/images/iphone-1.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
					    </div>
		    ...
		    <div class="item" style="background-image:url(static/images/slide_5.jpg)">
		...
		<div class="container">
			<div class="row row-bottom-padded-lg" id="about-us">
				...
				<div class="col-md-8 to-animate">
					<img src="static/images/img_1.jpg" class="img-responsive img-rounded" alt="Free HTML5 Template">
				</div>
			...
			<div class="row" id="team">
				...
				<div class="col-md-12">
					<div class="row row-bottom-padded-lg">
						...
						<div class="col-md-4 text-center to-animate">
							<div class="person">
								<img src="static/images/person3.jpg" class="img-responsive img-rounded" alt="Person">
						...
						<div class="col-md-4 text-center to-animate">
							<div class="person">
								<img src="static/images/person4.jpg" class="img-responsive img-rounded" alt="Person">
								<h3 class="name">John Doe</h3>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="fh5co-press-item to-animate">
						<div class="fh5co-press-img" style="background-image: url(static/images/img_7.jpg)">
						</div>
				...
				<div class="col-md-6">
					<!-- Press Item -->
					<div class="fh5co-press-item to-animate">
						<div class="fh5co-press-img" style="background-image: url(static/images/img_8.jpg)">
						</div>
						<div class="fh5co-press-text">
				...
				<div class="col-md-6">
					<!-- Press Item -->
					<div class="fh5co-press-item to-animate">
						<div class="fh5co-press-img" style="background-image: url(static/images/img_9.jpg);">
						</div>
						<div class="fh5co-press-text">
				...
				<div class="col-md-6">
					<!-- Press Item -->
					<div class="fh5co-press-item to-animate">
						<div class="fh5co-press-img" style="background-image: url(static/images/img_10.jpg);">
						</div>
						<div class="fh5co-press-text">
